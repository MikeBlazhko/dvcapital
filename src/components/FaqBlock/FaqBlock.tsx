            ...
            <div className={styles.content}>
                ...
                <div className={styles.items}>
                    <ExpandedItem title="Сколько стоит факторинг?">
                        <span>Стоимость факторинга зависит от нескольких факторов: суммы финансирования, срока отсрочки платежа, рейтинга дебитора, стоимости товара и т. д.</span>
                       <span>{'\n\n'}</span>
                        <span>В стоимость факторинга обычно входят:</span>
                        <ul>
                            <li>комиссия за обработку документов;</li>
                            <li>процент за использование денежных средств (определяется ставкой);</li>
                            <li>плата за кредитный риск;</li>
                            <li>дополнительные услуги (например, страхование рисков).</li>
                        </ul>
                        <span>Для получения точной информации о стоимости факторинга необходимо обратиться к нашим специалистам.</span>
                    </ExpandedItem>
